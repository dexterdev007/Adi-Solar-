...
export const metadata: Metadata = {
  title: "Solar Panel Installation in Ranchi | Free Site Visit | AdiSolar",
  description:
    "Certified solar installation in Ranchi, Jharkhand. Residential and commercial. JBVNL net metering and PM Surya Ghar subsidy handled. Free site visit.",
  alternates: { canonical: "https://adisolar.in/solar-installation-ranchi" },
};

const cityData = {
  cityName: "Ranchi",
  stateName: "Jharkhand",
  discom: "JBVNL (Jharkhand Bijli Vitran Nigam Limited)",
  avgBill: "₹1,500–₹6,000",
  sunHours: "5.2",
};
...
export default function RanchiPage() {
  return (
    <main>
      ...
      <WhySolarInCity
        {...cityData}
        customNote="Ranchi, the capital of Jharkhand, has a growing middle class with significant government and PSU employee population. AdiSolar also specialises in institutional solar installations for schools, colleges, and hospitals — a strong and underserved segment in the region. With JBVNL net metering, your surplus power earns credits on every bill."
      />

      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader caption="Our Customers" heading="Solar Solutions for Every Need in Ranchi" className="mb-12 text-center" />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: HomeIcon, title: "Residential", desc: "Homes, PSU employee quarters, and apartments across Ranchi." },
      ...
      <section className="py-20 lg:py-28 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionHeader caption="How It Works" heading="Our Installation Process in Ranchi" className="mb-12 text-center" />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              { step: 1, title: "Free Site Visit", body: "Our engineer visits your Ranchi property at zero cost." },
              { step: 2, title: "Energy Evaluation", body: "We assess your consumption and roof for the right system size." },
              { step: 3, title: "Custom Design", body: "A system designed for your property and JBVNL requirements." },
              { step: 4, title: "Professional Installation", body: "Certified technicians install your system in 1–2 days." },
              { step: 5, title: "Monitor & Support", body: "Net metering with JBVNL and ongoing monitoring." },
            ].map((s) => (
      ...
      <section className="py-16 bg-primary text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl font-bold font-heading text-white mb-4">Ready to go solar in Ranchi?</h2>
